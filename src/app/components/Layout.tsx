...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-violet-50/40 pb-24 font-sans selection:bg-violet-100">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-xl border-t border-violet-100/60 shadow-[0_-4px_20px_-4px_rgba(139,92,246,0.07)] z-20">
